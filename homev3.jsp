...
<script>
// 카카오 초기화
Kakao.init('65e6b28102cdd12d73525a846b6cd9f5');
		...
		<div class="login-content">
			...
			<div class="row">
				...
				<div class="social-btn-2">
					<a class="btn btnkakao" id="kakao-login-btn" style="text-align:center;" href="javascript:kakaoLogin()">카카오 1초 로그인/회원가입</a><a
