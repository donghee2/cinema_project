...
window.onload = function(){
    ...
    window.Kakao.init('65e6b28102cdd12d73525a846b6cd9f5');
...
?client_id=7a35d3038a1822b8222b982de5e2a288
&redirect_uri=	
http://localhost:9999
&response_type=code
&scope=account_email
		...
		<div class="login-content">
			...
			<div class="row">
				...
				<div class="social-btn-2">
					<a class="fb" href="#" id="kakaoLogin"><i class="kakaoLogo"><img src="images/ico-kakao.png" style="width: 30px; height: 30px;"></i>kakao</a><a
			...
			<nav id="mainNav" class="navbar navbar-default navbar-custom">
				...
				<div class="collapse navbar-collapse flex-parent"
					...
					<ul class="nav navbar-nav flex-child-menu menu-right">
						...
						<li><a href="#" class="kakaoLogout secession out_in" ><span class="logout_text">로그아웃</span></a></li>
						<%	
						}
						%>
					</ul>
						...
						<div class="blog-it-infor">
							<h3>
								<a href="blogdetail.html">First Official Images of Alicia
									Vikander As Tomb Raider’s Lara Croft</a>
							</h3>
							<span class="time">27 Mar 2017</span>
